...
class SimulationConfig:
    """Configuration for Experiment 1 (coplanarity ablation study).

    Effective proportional gains near equilibrium (paper Sec. V-B):
      k_θ ≈ 1.67,  k_d ≈ 3.70,  k_n ≈ 4.01,  k_cop ≈ 8.15,  k_v ≈ 5.66
    """
    ...
    output_dir: Path = ROOT / "output" / "double_integrator" / "exp_1_with_coplanar"
...
class UndirectedFormationController:
    """Five-term distributed formation controller (paper eq. 40).
    ...
    def __init__(self, config: SimulationConfig):
        ...
        # coplanarity term: k_cop(e) · e_cop · n_234
        self.bp_cop = 0.4
        self.d_p_cop = 0.05
        self.mu_p_cop = 0.5
    ...
    def control_law_output(
        ...
        """Evaluate control law (paper eq. 40) at current state."""
        ...
        # ── Term 4: coplanarity constraint (paper eq. 40, k_cop term) ──
        ...
        u[2] -= cop_gain * coplanar_error * n234_local  # force on agent 3 only
